"""A replacement for monzo.monzo.Monzo for testing purposes"""
...
class Monzo(object):
    ...
    def whoami(self):
        ...
        """
        return {"authenticated": True, "client_id": "client_id", "user_id": "user_id"}
    ...
    def get_balance(self, account_id):
        ...
        """
        return {"balance": 5000, "currency": "GBP", "spend_today": 0}
